    ...
    <section className="bg-app-dark py-12 text-white sm:py-20 lg:py-24">
      <div className="section-wrap space-y-6 sm:space-y-8">
        <div className="max-w-3xl">
          <p className="eyebrow fade-up text-white/72">City scale</p>
          <h2 className="fade-up stagger-1 mt-3 text-[30px] font-normal leading-[1.02] tracking-[-0.04em] text-white sm:text-[44px]">
            {t("stats.title")}
          </h2>
          <p className="fade-up stagger-2 mt-4 max-w-xl text-[15px] leading-7 text-white/82 sm:mt-5 sm:text-[16px] sm:leading-8">
            {t("stats.copy")}
          </p>
        </div>
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          {stats.map((stat, index) => (
            <Card
              key={stat.label}
              className="dark-card fade-up hover-lift-soft p-5 transition-shadow duration-300 ease-[var(--motion-smooth)] hover:shadow-[0_26px_48px_-30px_rgba(0,0,0,0.55)] sm:p-6"

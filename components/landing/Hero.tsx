...
export function Hero() {
  ...
  return (
    <section className="bg-app-dark px-4 pb-10 pt-8 text-white sm:px-6 lg:px-8 lg:pb-14 lg:pt-10">
      <div className="mx-auto max-w-[1400px] overflow-hidden rounded-[var(--radius)] border border-white/10 bg-app-dark px-6 py-8 sm:px-8 lg:px-10 lg:py-12">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(360px,0.95fr)] lg:items-center">
          <div className="max-w-3xl">
            ...
            <h1 className="display-title-dark mt-6 max-w-4xl">{t("hero.title")}</h1>
            <p className="mt-6 max-w-2xl text-[17px] leading-8 text-white/82 sm:text-[18px]">{t("hero.copy")}</p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Button asChild variant="unstyled" size="unstyled" className="inline-flex min-h-[56px] items-center justify-center gap-2 rounded-full bg-brand-600 px-8 py-4 text-[16px] font-semibold text-white">
                <Link href="/report">
                  {t("hero.report")}
          ...
          <div className="relative min-h-[420px]">
            <Card className="dark-card absolute inset-x-0 top-0 p-6 shadow-[0_28px_60px_rgba(0,0,0,0.32)]">
            ...
            <Card className="dark-card absolute bottom-0 right-0 w-[82%] -rotate-[5deg] p-5 shadow-[0_22px_50px_rgba(0,0,0,0.28)]">
              <p className="text-[12px] font-semibold uppercase tracking-[0.08em] text-white/72">
